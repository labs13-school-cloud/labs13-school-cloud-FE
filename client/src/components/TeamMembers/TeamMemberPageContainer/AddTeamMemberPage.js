			...
			<MainContainer>
				<form className={classes.form} onSubmit={(e) => this.addNewTeamMember(e)}>
					<Paper className={classes.paper}>
							...
							<FormControlLabel
								control={
									<Switch
										...
										onChange={textDisabled ? null : this.handleToggleChange('textOn')}
										value="textOn"
										color="default"
										style={
											this.state.teamMember.textOn ? { color: '#451476' } : { color: '#edeaea' }
										}
									/>
								}
							...
							<FormControlLabel
								control={
									<Switch
										...
										onChange={emailDisabled ? null : this.handleToggleChange('emailOn')}
										value="emailOn"
										color="default"
										style={
											this.state.teamMember.emailOn ? { color: '#451476' } : { color: '#edeaea' }
										}
									/>
								}
						...
						<ButtonContainer>
							<Button
								disabled={this.state.isRouting || addDisabled === true ? true : null}
								variant="contained"
							...
							<Button className={classes.button} onClick={(e) => this.handleCancel(e)}>
								Cancel
							</Button>
						</ButtonContainer>
					</Paper>
...
export default connect(mapStateToProps, { addTeamMember })(withStyles(styles)(TeamMemberPage));
