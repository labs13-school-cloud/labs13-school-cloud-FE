...
// Redux
import { getTrainingSeriesMessages, createAMessage, editMessage, deleteMessage, getMessageById } from 'store/actions';
...
class CreatePost extends React.Component {
	...
	handlePostSubmit = (e) => {
		e.preventDefault();
		this.props.createAMessage(this.state.post, this.state.post.trainingSeriesID);
	};
	...
	render() {
		...
		return (
			<form className={classes.form} id="form1" onSubmit={(e) => this.handlePostSubmit(e)}>
						...
						<PostContainer>
							...
							<ExpansionPanel>
								...
								<ExpansionPanelDetails>
									<Typography>
										This is the number of days after a training series starts that a message will be
										sent. For example, if you assign a team member to this training series with a
										start date of today, and you set this message's "days from start" number to 3,
										it will send out on {sendDay}.
									</Typography>
								</ExpansionPanelDetails>
							</ExpansionPanel>
						</PostContainer>
						<ButtonContainer>
							<Button variant="outlined" className={classes.createButton} type="submit" form="form1">
								Create
							</Button>
							<Button
