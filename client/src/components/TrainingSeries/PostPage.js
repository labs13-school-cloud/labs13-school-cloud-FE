...
class PostPage extends React.Component {
	...
	handlePostSubmit = (e) => {
		...
		this.props.editMessage(this.state.post.postID, this.state.post);

		setTimeout(() => {
			this.props.history.push(`/home/training-series/${this.state.post.trainingSeriesID}`);
		}, 1000);
	};
		...
		return (
			<MainContainer>
				...
				<form className={classes.form} id="form1" onSubmit={(e) => this.handlePostSubmit(e)}>
					...
					<ButtonContainer>
						<Button variant="outlined" className={classes.saveButton} type="submit" form="form1">
							Save
						</Button>
						<Button
							variant="contained"
