	...
	return (
		<div>
			<Grid container spacing={24}>
				...
				<Grid item xs={8}>
					<p style={{ marginTop: 0 }}>This training series includes messages:</p>
					...
					<p>
						and is <span style={{ color: 'blue' }}>{daysLong}</span> day(s) long.
					</p>
				</Grid>

				<Grid item xs={4} align="center">
					<Grid item>
						<Typography variant="overline">messages: {messageLength}</Typography>
					</Grid>
				</Grid>
			</Grid>
		</div>
